...
ActiveRecord::Schema.define(version: 20_201_109_102_553) do
  ...
  create_table 'industries', id: :uuid, default: -> { 'gen_random_uuid()' }, comment: '業種', force: :cascade do |t|
    ...
    t.index %w[name industry_category_id], name: 'index_industries_on_name_and_industry_category_id', unique: true
  end
